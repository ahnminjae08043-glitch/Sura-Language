...
As a stress test of the language, this repository also contains **Sura OS**:
a UEFI-booted operating system whose kernel modules, TLS 1.3 stack, FAT32
driver, window server, and web browser are written in Sura itself — and it
runs a port of DOOM. See [Guide/OS_DEVELOPMENT.md](Guide/OS_DEVELOPMENT.md).
It is showcase-tier, not part of the stable surface ([SCOPE.md](SCOPE.md)).
