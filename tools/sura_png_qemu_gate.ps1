...
$source = Join-Path $root "examples/os/png_qemu_gate.sura"
...
if (-not (Test-Path -LiteralPath $source -PathType Leaf)) {
    throw "PNG QEMU source was not found: $source"
}
...
$arguments = @{
    ...
    ExpectedEfiText = "Sura PNG decode test"
    ExpectedMarker = "SURA_PNG_DECODE_OK"
    ExpectedExitCode = 33
}
if ($CompileOnly) {
