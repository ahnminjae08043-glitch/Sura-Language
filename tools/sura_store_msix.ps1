...
try {
    ...
    foreach ($requiredEntry in @(
        ...
        "stdlib/freestanding/css_box.sura",
        "stdlib/freestanding/css_style.sura",
        "stdlib/freestanding/elf64.sura",
        "stdlib/freestanding/fat32.sura",
        "stdlib/freestanding/font5x7.sura",
        "stdlib/freestanding/font_hangul.sura",
        "stdlib/freestanding/framebuffer.sura",
        "stdlib/freestanding/gpt.sura",
        "stdlib/freestanding/gzip.sura",
        "stdlib/freestanding/hda.sura",
        "stdlib/freestanding/html_dom.sura",
        "stdlib/freestanding/http1.sura",
        "stdlib/freestanding/http_content.sura",
        "stdlib/freestanding/ioapic.sura",
        "stdlib/freestanding/ipc.sura",
        "stdlib/freestanding/jpeg.sura",
        "stdlib/freestanding/key_event.sura",
        "stdlib/freestanding/memfs.sura",
        "stdlib/freestanding/nvme.sura",
        "stdlib/freestanding/partition.sura",
        "stdlib/freestanding/pci.sura",
        "stdlib/freestanding/pcie.sura",
        "stdlib/freestanding/png.sura",
        "stdlib/freestanding/preempt.sura",
        "stdlib/freestanding/power.sura",
        "stdlib/freestanding/process_memory.sura",
        "stdlib/freestanding/process_syscall.sura",
        "stdlib/freestanding/ps2.sura",
        "stdlib/freestanding/desktop_shell.sura",
        "stdlib/freestanding/desktop_apps.sura",
        "stdlib/freestanding/rtc.sura",
        "stdlib/freestanding/fat32_vfs.sura",
        "stdlib/freestanding/scheduler.sura",
        "stdlib/freestanding/serial.sura",
        "stdlib/freestanding/surafs.sura",
        "stdlib/freestanding/syscall.sura",
        "stdlib/freestanding/text_input.sura",
        "stdlib/freestanding/text_terminal.sura",
        "stdlib/freestanding/timer.sura",
        "stdlib/freestanding/user_process.sura",
        "stdlib/freestanding/vfs.sura",
        "stdlib/freestanding/virtio_gpu.sura",
        "stdlib/freestanding/virtio_pci.sura",
        ...
        "examples/os/css_box_qemu_gate.sura",
        "examples/os/css_style_qemu_gate.sura",
        "examples/os/desktop_shell_features.sura",
        "examples/os/desktop_apps_features.sura",
        "examples/os/fat32_features.sura",
        "examples/os/fat32_mutation_qemu_gate.sura",
        "examples/os/framebuffer_features.sura",
        "examples/os/gpt_features.sura",
        "examples/os/gzip_qemu_gate.sura",
        "examples/os/hda_qemu_gate.sura",
        "examples/os/html_dom_qemu_gate.sura",
        "examples/os/http1_qemu_gate.sura",
        "examples/os/ioapic_features.sura",
        "examples/os/integer_semantics_qemu_gate.sura",
        "examples/os/ipc_features.sura",
        "examples/os/jpeg_qemu_gate.sura",
        "examples/os/memfs_features.sura",
        ...
        "examples/os/png_qemu_gate.sura",
        ...
        "examples/os/process_elf_features.sura",
        "examples/os/process_syscall_features.sura",
        "examples/os/ps2_features.sura",
        "examples/os/qemu_boot_gate.sura",
        "examples/os/rtc_features.sura",
        "examples/os/scheduler_features.sura",
        "examples/os/syscall_features.sura",
        "examples/os/surafs_qemu_gate.sura",
        "examples/os/text_input_features.sura",
        "examples/os/text_terminal_features.sura",
        "examples/os/user_mode_features.sura",
        "examples/os/user_process_features.sura",
        "examples/os/user_process_qemu_gate.sura",
        "examples/os/vfs_features.sura",
        "examples/os/virtio_gpu_qemu_gate.sura",
