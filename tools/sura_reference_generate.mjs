...
const machineFacts = {
  ...
  freestanding: {
    ...
    ahci_library: {
      ...
      limitations: ["no executed AHCI command proof", "no interrupts or NCQ", "one outstanding command", "no ATAPI or port multiplier", "no hot-plug, TRIM, COMRESET recovery, or power management", "no IOMMU mapping", "no NVMe"],
    },
    fat32_library: {
