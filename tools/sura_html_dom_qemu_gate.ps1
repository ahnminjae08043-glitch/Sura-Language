...
$source = Join-Path $root "examples/os/html_dom_qemu_gate.sura"
...
if (-not (Test-Path -LiteralPath $source -PathType Leaf)) {
    throw "HTML DOM QEMU source was not found: $source"
}
...
$arguments = @{
    ...
    ExpectedEfiText = "Sura HTML DOM test"
    ExpectedMarker = "SURA_HTML_DOM_OK"
    ExpectedExitCode = 33
}
if ($CompileOnly) {
