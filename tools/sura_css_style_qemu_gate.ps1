...
$source = Join-Path $root "examples/os/css_style_qemu_gate.sura"
...
if (-not (Test-Path -LiteralPath $source -PathType Leaf)) {
    throw "CSS style QEMU source was not found: $source"
}
...
$arguments = @{
    ...
    ExpectedEfiText = "Sura CSS style test"
    ExpectedMarker = "SURA_CSS_STYLE_OK"
    ExpectedExitCode = 33
}
if ($CompileOnly) {
